package com.otilm.common.credential.provider.util;
...
class SecretsUtilTest {
    ...
    class FormatValidationTests {
        ...
        @MethodSource("com.otilm.common.credential.provider.util.SecretsUtilTest#invalidFormatSecrets")
    ...
    class TamperingDetectionTests {
        ...
        @MethodSource("com.otilm.common.credential.provider.util.SecretsUtilTest#tamperedSecrets")
    ...
    class EdgeCasesTests {
        ...
        @MethodSource("com.otilm.common.credential.provider.util.SecretsUtilTest#edgeCaseSecrets")
